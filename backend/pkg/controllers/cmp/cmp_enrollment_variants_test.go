...
func TestHandleCMP_P10CR_IssuesCP(t *testing.T) {
	...
	router, store, svc := newEnrollRouter(t, models.CMPEnrollmentSettings{AcceptImplicit: true, P10CR: models.CMPP10CRSettings{Enabled: true}}, issuedCert)
...
func TestHandleCMP_P10CR_ExplicitConfirm(t *testing.T) {
	...
	router, store, _ := newEnrollRouter(t, models.CMPEnrollmentSettings{P10CR: models.CMPP10CRSettings{Enabled: true}}, issuedCert)
...
func TestHandleCMP_P10CR_BadSignature(t *testing.T) {
	router, _, svc := newOptionsRouter(t, models.CMPEnrollmentSettings{P10CR: models.CMPP10CRSettings{Enabled: true}})
...
func TestHandleCMP_P10CR_PollReq_DeliversCP(t *testing.T) {
	...
	router, _, _ := newEnrollRouter(t, models.CMPEnrollmentSettings{AcceptImplicit: true, P10CR: models.CMPP10CRSettings{Enabled: true}}, issuedCert)
