...
func (mw DmsAuditEventPublisher) ApproveCMPTransaction(ctx context.Context, input services.ApproveCMPTransactionInput) (*models.CMPTransaction, error) {
	return mw.next.ApproveCMPTransaction(ctx, input)
}

func (mw DmsAuditEventPublisher) RejectCMPTransaction(ctx context.Context, input services.RejectCMPTransactionInput) (*models.CMPTransaction, error) {
...
func (mw DmsAuditEventPublisher) LWCRevokeCertificate(ctx context.Context, input services.RevokeCertificateInput, signerCert *x509.Certificate) error {
...
func (mw DmsAuditEventPublisher) LWCGetEnrollmentOptions(ctx context.Context, aps string) (*services.LWCEnrollmentOptions, error) {
	return mw.next.LWCGetEnrollmentOptions(ctx, aps)
}

func (mw DmsAuditEventPublisher) LWCProtectionCredentials(ctx context.Context, aps string) ([]*x509.Certificate, crypto.Signer, error) {
