...
func TestKeyStrengthMetadataFromCertificate(t *testing.T) {
	...
	expected1 := models.KeyStrengthLow
	...
	expected2 := models.KeyStrengthMedium
	...
	expected3 := models.KeyStrengthHigh
	...
	expected5 := models.KeyStrengthMedium
	...
	expected6 := models.KeyStrengthHigh
