...
type CertificatesRepo interface {
	...
	SelectByCAIDAndStatus(ctx context.Context, CAID string, status models.CertificateStatus, exhaustiveRun bool, applyFunc func(models.Certificate), queryParams *resources.QueryParameters, extraOpts map[string]interface{}) (string, error)
	SelectByStatus(ctx context.Context, status models.CertificateStatus, exhaustiveRun bool, applyFunc func(models.Certificate), queryParams *resources.QueryParameters, extraOpts map[string]interface{}) (string, error)
