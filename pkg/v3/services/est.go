...
type ESTService interface {
	...
	Enroll(authMode models.ESTAuthMode, authOptions interface{}, csr *x509.CertificateRequest, aps string) (*x509.Certificate, error)

	// Reenroll requests renewal/rekey of an existing certificate. See RFC7030
	// 4.2.
	Reenroll(authMode models.ESTAuthMode, authOptions interface{}, csr *x509.CertificateRequest, aps string) (*x509.Certificate, error)
	...
	// RFC7030 4.4.
	ServerKeyGen(authMode models.ESTAuthMode, authOptions interface{}, csr *x509.CertificateRequest, aps string) (*x509.Certificate, interface{}, error)
