...
type DB interface {
	...
	SelectAllDevicesByDmsId(ctx context.Context, dms_id string, queryParameters filters.QueryParameters) ([]dto.Device, int, error)
	...
	SelectDeviceLogs(ctx context.Context, id string, queryParameters filters.QueryParameters) ([]dto.DeviceLog, int, error)
	...
	SelectDmssLastIssuedCert(ctx context.Context, queryParameters filters.QueryParameters) ([]dto.DMSLastIssued, int, error)
}
