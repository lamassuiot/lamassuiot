...
// 			}
// 			if err == nil {
// 				err = srv.RevokeCA(ctx, caType, tc.newCert.Name)
// 				if err != nil {
...
// 	srv.SignCertificate(ctx, caType, "testRevokeCA", *csr, false, csr.Subject.CommonName)
...
// 			err = srv.RevokeCA(ctx, caType, tc.cert.Name)
// 			if err != nil {
// 				if err.Error() != tc.ret.Error() {
// 					t.Errorf("Got result is %s; want %s", err, tc.ret)
// 				}
