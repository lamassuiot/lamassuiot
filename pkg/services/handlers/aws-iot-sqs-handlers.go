...
func NewAWSIoTThingConnectionDisconnectionEventHandler(l *logrus.Entry, svc iot.AWSCloudConnectorService) EventHandler {
...
func NewAWSIoTThingShadowUpdateEventHandler(l *logrus.Entry, svc iot.AWSCloudConnectorService) EventHandler {
