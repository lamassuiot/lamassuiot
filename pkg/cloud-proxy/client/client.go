...
// 	cloudproviders "github.com/lamassuiot/lamassuiot/pkg/cloud-proxy/common/api"
// 	clientUtils "github.com/lamassuiot/lamassuiot/pkg/utils/client"
// )

// type LamassuCloudProxyClient interface {
// 	GetCloudConnectors(ctx context.Context) ([]api.CloudConnector, error)
...
// func NewLamassuCloudProxyClient(config clientUtils.BaseClientConfigurationuration) (LamassuCloudProxyClient, error) {
