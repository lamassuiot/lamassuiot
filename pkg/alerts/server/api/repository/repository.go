...
type AlertsRepository interface {
	...
	Subscribe(ctx context.Context, userID string, channel api.Channel, conditions []string, eventType string, conditionType api.ConditionType, expectedValue string) error
