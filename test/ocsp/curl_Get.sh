...
curl -k --location --request GET "https://$DOMAIN/api/ocsp/$OCSP_REQUEST" > ocspresponse.der
openssl ocsp -respin ocspresponse.der -VAfile root-ca.pem -resp_text > response.txt