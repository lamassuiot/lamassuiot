...
func TestVaultCryptoEngine(t *testing.T) {
	table := []struct {
		...
		{"CreateSLHDSASHA2_128sPrivateKey", cryptoengines.SharedTestCreateSLHDSAPrivateKey},
		...
		{"ImportSLHDSAPrivateKey", cryptoengines.SharedTestImportSLHDSAPrivateKey},
		{"CreateCompositeMLDSARSAVariant1PrivateKey", cryptoengines.SharedTestCreateCompositeMLDSARSAPrivateKey},
		{"ImportCompositeMLDSARSAPrivateKey", cryptoengines.SharedTestImportCompositeMLDSARSAPrivateKey},
		...
		{"SignSLHDSA", cryptoengines.SharedTestSLHDSASignature},
		{"SignCompositeMLDSARSA", cryptoengines.SharedTestCompositeMLDSARSASignature},
