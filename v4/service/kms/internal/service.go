...
type KMSServiceBackend struct {
	service               kms.KMSService
	kmsStorage            KMSKeysRepo
...
func NewKMSService(builder KMSServiceBuilder) (kms.KMSService, error) {
...
func (svc *KMSServiceBackend) SetService(service kms.KMSService) {
	svc.service = service
}
...
func (svc *KMSServiceBackend) GetKeys(ctx context.Context, input kms.GetKeysInput) (string, error) {
	lFunc := chelpers.ConfigureLogger(ctx, svc.logger)

	nextBookmark, err := svc.kmsStorage.SelectAll(ctx, storage.StorageListRequest[kms.Key]{
...
func (svc *KMSServiceBackend) GetKeyByID(ctx context.Context, input kms.GetKeyByIDInput) (*kms.Key, error) {
	lFunc := chelpers.ConfigureLogger(ctx, svc.logger)
...
func (svc *KMSServiceBackend) CreateKey(ctx context.Context, input kms.CreateKeyInput) (*kms.Key, error) {
	lFunc := chelpers.ConfigureLogger(ctx, svc.logger)
...
func (svc *KMSServiceBackend) ImportKey(ctx context.Context, input kms.ImportKeyInput) (*kms.Key, error) {
	lFunc := chelpers.ConfigureLogger(ctx, svc.logger)
...
func (svc *KMSServiceBackend) DeleteKeyByID(tx context.Context, input kms.GetKeyByIDInput) error {
...
func (svc *KMSServiceBackend) SignMessage(ctx context.Context, input kms.SignMessageInput) (*kms.MessageSignature, error) {
	lFunc := chelpers.ConfigureLogger(ctx, svc.logger)
	...
	return &kms.MessageSignature{
		Signature: base64.StdEncoding.EncodeToString(signature),
	}, nil
}

func (svc *KMSServiceBackend) VerifySignature(ctx context.Context, input kms.VerifySignInput) (*kms.MessageValidation, error) {
	lFunc := chelpers.ConfigureLogger(ctx, svc.logger)
