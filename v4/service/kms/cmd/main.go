...
import (
	...
	"github.com/lamassuiot/lamassuiot/service/kms/internal"
...
func main() {
	...
	conf, err := cconfig.LoadConfig[internal.ServiceConfig](nil)
	if err != nil {
	...
	_, _, err = internal.AssembleKMSServiceWithHTTPServer(*conf, models.APIServiceInfo{
		Version:   version,
		BuildSHA:  sha1ver,
		BuildTime: buildTime,
	})
